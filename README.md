...
* Microsoft Agent Framework in the MAUI client, using the official MCP .NET client over Streamable HTTP to expose robot commands to an OpenAI-compatible model
